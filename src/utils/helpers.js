...
export const ICONS = {
    ...
    video: "M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9A2.25 2.25 0 004.5 18.75z",
    ...
    star: "M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z",
    users: "M17 20v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m8-10a4 4 0 100-8 4 4 0 000 8z",
    ...
    squares2x2: "M3.75 3.75h4.5v4.5h-4.5v-4.5zm0 12h4.5v4.5h-4.5v-4.5zm12-12h4.5v4.5h-4.5v-4.5zm0 12h4.5v4.5h-4.5v-4.5z",
    globe: "M12 22a10 10 0 110-20 10 10 0 010 20z M2 12h20 M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z",
    ...
    share: "M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3v12",
    refresh: "M16.023 9.348h4.992v-.001a.75.75 0 01.387.892l-1.92 6.5A.75.75 0 0118.5 17H4.5a.75.75 0 01-.712-.956l1.92-6.5A.75.75 0 016.09 9h4.918M10.231 7.5h3.536a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0v-1.5H10.23a.75.75 0 01-.75-.75V7.5a.75.75 0 01.75-.75z",
    youtube: "M8.051 1.999h.089c.822.003 4.987.033 6.11.335a2.01 2.01 0 0 1 1.415 1.42c.101.38.172.883.22 1.402l.01.104.022.26.008.104c.065.914.073 1.77.074 1.957v.075c-.001.194-.01 1.108-.082 2.06l-.022.26-.008.104c-.048.519-.119 1.023-.22 1.402a2.01 2.01 0 0 1-1.415 1.42c-1.16.302-5.169.33-6.18.335h-.09c-.822-.003-4.987-.033-6.11-.335a2.01 2.01 0 0 1-1.415-1.42c-.101-.38-.172-.883-.22-1.402l-.01-.104-.022-.26-.008-.104c-.065-.914-.073-1.77-.074-1.957v-.075c.001-.194.01-1.108.082-2.06l.022.26.008.104c.048-.519.119-1.023.22-1.402a2.01 2.01 0 0 1 1.415-1.42c1.16-.302 5.169-.33 6.18-.335zM6.4 5.209v4.818l4.157-2.408L6.4 5.209z",
    twitch: "M3.857 0 1 2.857v10.286h3.429V16l2.857-2.857H9.57L14.714 8V0zm9.714 7.429-2.285 2.285H9l-2 2v-2H4.429V1.143h9.142zM11.857 3.143h-1.143V6.57h1.143zm-3.143 0H7.571V6.57h1.143z",
    instagram: "M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.9 3.9 0 0 0-1.417.923A3.9 3.9 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.9 3.9 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.198-.51.333-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.174-1.433-.372-1.942a3.9 3.9 0 0 0-.923-1.417A3.9 3.9 0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0zm0 1.442c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599s.453.546.598.92c.11.281.24.705.275 1.486.039.843.047 1.096.047 3.232s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.5 2.5 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.5 2.5 0 0 1-.92-.598 2.5 2.5 0 0 1-.598-.92c-.11-.28-.24-.705-.276-1.485-.038-.843-.046-1.096-.046-3.232s.008-2.389.046-3.232c.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92s.546-.453.92-.598c.282-.11.705-.24 1.485-.276.843-.038 1.096-.047 3.232-.047zM8 3.882a4.108 4.108 0 1 0 0 8.216 4.108 4.108 0 0 0 0-8.216zm0 6.762a2.654 2.654 0 1 1 0-5.308 2.654 2.654 0 0 1 0 5.308zm4.965-6.415a.96.96 0 1 0 0 1.92.96.96 0 0 0 0-1.92z",
    ...
    twitterX: "M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.602.75zM11.5 13.51L12.91 15.25h1.54L6.95 2.05H5.28l8.31 11.46h-2.09z",
    discord: "M13.545 2.907a13.2 13.2 0 0 0-3.257-1.011.05.05 0 0 0-.052.025c-.141.25-.297.577-.406.833a12.2 12.2 0 0 0-3.658 0 8 8 0 0 0-.412-.833.05.05 0 0 0-.052-.025c-1.125.194-2.22.534-3.257 1.011a.04.04 0 0 0-.021.018A13.4 13.4 0 0 0 .5 10.15a.05.05 0 0 0 .017.036l.351.272A12.5 12.5 0 0 0 3.766 12.4a.05.05 0 0 0 .065-.018 10.4 10.4 0 0 0 .37-.566.05.05 0 0 0-.01-.061 11.4 11.4 0 0 0-1.578-.437.05.05 0 0 0-.041.017s-.001.002-.002.003a12.5 12.5 0 0 0-1.01 1.745.05.05 0 0 0 .046.063l.39.152a12.5 12.5 0 0 0 6.34-1.63.05.05 0 0 0 .022-.057 1.01 1.01 0 0 0-.012-.016 10.4 10.4 0 0 0 .38-.566.05.05 0 0 0-.009-.061 11.4 11.4 0 0 0-1.578-.437.05.05 0 0 0-.041.017s-.001.002-.002.003a12.5 12.5 0 0 0-1.01 1.745.05.05 0 0 0 .046.063l.39.152a12.5 12.5 0 0 0 6.34-1.63.05.05 0 0 0 .022-.057 1.01 1.01 0 0 0-.012-.016c.117-.208.232-.416.34-.633a.05.05 0 0 0-.009-.061 11.4 11.4 0 0 0-1.578-.437.05.05 0 0 0-.041.017s-.001.002-.002.003a12.5 12.5 0 0 0-1.01 1.745.05.05 0 0 0 .046.063l.39.152a12.5 12.5 0 0 0 6.34-1.63.05.05 0 0 0 .022-.057c0-.001-.002-.002-.002-.003a13.4 13.4 0 0 0-3.08-6.993.05.05 0 0 0-.021-.018z",
    eye: "M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.432 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z",
    ...
    toggle: "M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12",
    dragHandle: "M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5",
    copy: "M9 5.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25V15M9 5.25v-1.5A2.25 2.25 0 0111.25 1.5h1.5a2.25 2.25 0 012.25 2.25v1.5m-3 0h-3",
    heart: "M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z",
    infoCircle: "M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.852l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z",
    ...
    info: "M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.852l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z",
...
// Robuste YouTube-Helfer — verkraften watch?v=, youtu.be/ (auch mit ?si=-Parametern),
// /embed/ und /shorts/-URLs. Die naive split('v=')-Extraktion scheiterte an
