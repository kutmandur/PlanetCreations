...
const offlineManagerApi = {
  ...
  onFrontierSaveFilesChanged: (callback) => listen('frontier-save-files-changed', callback, (_event, payload) => [payload]),
    ...
    readPlanetZooAnalysis: (filePath) => ipcRenderer.invoke('read-planet-zoo-analysis', filePath),
...
const hostedApi = {
  ...
  onSystemPowerState: (callback) => listen('system-power-state', callback, (_event, state) => [state]),
  ...
  getOverlayAutoEnabled: () => ipcRenderer.invoke('get-overlay-auto-enabled'),
  setOverlayAutoEnabled: (value) => ipcRenderer.invoke('set-overlay-auto-enabled', value),
  onOverlayAutoEnabledChanged: (callback) => listen('overlay-auto-enabled-changed', callback, (_event, value) => [value]),
  ...
  getOverlayHotkeys: () => ipcRenderer.invoke('get-overlay-hotkeys'),
  setOverlayHotkeys: (shortcuts) => ipcRenderer.invoke('set-overlay-hotkeys', shortcuts),
  onOverlayHotkeysChanged: (callback) => listen('overlay-hotkeys-changed', callback, (_event, value) => [value]),
