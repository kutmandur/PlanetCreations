...
const { autoUpdater } = require('electron-updater'); // NEU: Importieren
...
function createWindow() {
    ...
    // --- NEU: Auto-Update Logik ---
    // Sucht nach Updates, sobald die App bereit ist.
    ...
    // Event, wenn ein Update heruntergeladen wurde.
    autoUpdater.on('update-downloaded', () => {
        win.webContents.send('update-downloaded');
    });

    // Listener, um die App neu zu starten und das Update zu installieren.
...
ipcMain.handle('backup-all-creations', (event, files, note) => backupAllCreations(app, files, note));
